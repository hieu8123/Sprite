...
SPRITE kitty; // Khai báo biến kiểu SPRITE để lưu trữ thông tin về con mèo
//timing variable
...
int Game_Init(HWND hwnd)
{
	...
	for (n = 0; n < 6; n++)
	{
		swprintf_s(s, sizeof(s) / sizeof(wchar_t), L"cat%d.png", n + 1);
		kitty_image[n] = LoadSurface(s, D3DCOLOR_XRGB(255, 0, 255));
		if (kitty_image[n] == NULL)
			return 0;
		background = LoadSurface(L"cat.png", D3DCOLOR_XRGB(255, 0, 255));
	}
